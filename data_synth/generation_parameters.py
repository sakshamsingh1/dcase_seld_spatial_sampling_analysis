...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        rirpath = '/home/iran/datasets/TAU-SRIR_DB',   # path containing Room Impulse Responses (RIRs)
        mixturepath = '/home/iran/datasets/synthetic_dcase',  # output path for the generated dataset
        ...
        rooms2fold = [[3,4], # FOLD 1, rooms assigned to each fold (0's are ignored)
                      [3,4]], # FOLD 2
        ...
        nb_mixtures_per_fold = [1600,400], #[900, 300], # if scalar, same number of mixtures for each fold
        mixture_duration = 60., #in seconds
        event_time_per_layer = 45., #in seconds (should be less than mixture_duration)
